...
icon=pygame.image.load("src/icon.jpg")
...
board= pygame.image.load("src/Snakes-and-Ladders-Bigger.jpg")
dice1=pygame.image.load("src/dice1.png")
dice2=pygame.image.load("src/dice2.png")
dice3=pygame.image.load("src/dice3.png")
dice4=pygame.image.load("src/dice4.png")
dice5=pygame.image.load("src/dice5.png")
dice6=pygame.image.load("src/dice6.png")

redgoti=pygame.image.load("src/redgoti.png")
yellowgoti=pygame.image.load("src/yellowgoti.png")
greengoti=pygame.image.load("src/greengoti.png")
bluegoti=pygame.image.load("src/bluegoti.png")
menubg=pygame.image.load("src/menu.jpg")
p=pygame.image.load("src/playbg.jpg")
intbg=pygame.image.load("src/intropic.png")
intbg2=pygame.image.load("src/intropic2.jpg")
intbg3=pygame.image.load("src/intropic3.jpg")
intbg4=pygame.image.load("src/intropic4.jpg")
intbg5=pygame.image.load("src/intropic5.jpg")
credits1=pygame.image.load("src/credits.jpg")
